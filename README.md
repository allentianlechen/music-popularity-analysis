...
| Metric | Value |
|--------|-------|
| R² (full model, leakage-free) | 0.445 |
| R² (audio-only, no artist) | 0.247 |
| MAE | 9.7 popularity points |
| CV R² (5-fold, pipeline) | 0.436 +/- 0.008 |
...
- `model.pkl` is compressed with `joblib` (38 MB vs 388 MB uncompressed) to fit in 512 MB RAM
